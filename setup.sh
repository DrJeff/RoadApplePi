...
sudo apt install -y dnsmasq hostapd libbluetooth-dev apache2 php7.2 php7.2-mysql php7.2-bcmath mariadb-server libmariadbclient-dev libmariadbclient-dev-compat uvcdynctrl
